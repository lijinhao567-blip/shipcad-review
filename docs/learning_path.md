...
- Object storage: current abstraction for drawings, rendered images, uploaded Vision/OCR inputs, and generated report Markdown; the database keeps report content/metadata for compatibility and lookup.
